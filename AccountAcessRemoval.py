# Account Acesss removal
import platform   # platform allow us to determine what type of system we're running on
import pwd
...
if platform.system() == "Windows":
    ...
    for user in w.Win32_UserAccount():
        ...
        if changeCriteria(username):
            print("Chnaging password: %s"%username)
            setWindowsPassword(username,"newpass")
else:
    import pwd
    for p in pwd.getpwall(): # to get full list of the user account pn the system
